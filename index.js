...
if(firstAnswer === 'left'){
    ...
    if (secondAnswer === 'follow') {
        ...
        if (thirdAnswer === 'ladder') {
            window.alert('After ascending a few feet up the ladder, one of its rungs, and you comedically fall through each of the rungs below. Sheepish, you return home.')
    ...
    if (secondAnswer === 'past the dragon') {
        ...
        if (thirdAnswer === 'stay') {
            window.alert('You and the dragn have an uplifting conversation about local politics and become lifelong friends.')
